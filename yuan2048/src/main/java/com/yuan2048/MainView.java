...
public class MainView extends View {
    ...
    //Intenal Constants（整形常量）
    /** 动画的执行时间   （System.nanoTime()中的纳秒，1亿代表0.1秒）*/
    ...
    private void drawNewGameButton(Canvas canvas, boolean lightUp) {
        ...
        drawDrawable(canvas,
                getResources().getDrawable(R.mipmap.ic_action_refresh),
